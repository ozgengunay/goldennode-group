...
public class TestGoldenNodeMap {
    ...
    public void test1() {
        ...
        Assert.assertTrue(expectedKey.contains(((Set<Entry<String, String>>) response).iterator().next().getKey()));
        Assert.assertTrue(expectedValue.contains(((Set<Entry<String, String>>) response).iterator().next().getValue()));
        ...
        Assert.assertEquals(false, response);
        response = m1.keySet();
        Collection<String> expectedK = new HashSet<>();
        expectedK.add("key1");
        expectedK.add("key2");
        expectedK.add("key3");
        expectedK.add("key1_");
        expectedK.add("key2_");
        Assert.assertTrue(TestUtil.contentsSame(expectedK, (Set<?>) response));
        response = m1.values();
        Assert.assertEquals(5, ((Collection<?>) response).size());
        List<String> expectedVal = new ArrayList<>();
        expectedVal.add("val1");
        expectedVal.add("\"val2\"");
        expectedVal.add("val3");
        expectedVal.add("val1_");
        expectedVal.add("val2_");
        Assert.assertTrue(TestUtil.contentsSame(expectedVal, (List<?>) response));
        response = m1.entrySet();
        Assert.assertTrue(expectedK.contains(((Set<Entry<String, String>>) response).iterator().next().getKey()));
        Assert.assertTrue(expectedVal.contains(((Set<Entry<String, String>>) response).iterator().next().getValue()));
