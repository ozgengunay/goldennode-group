...
public abstract class AbstractProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    protected abstract void additionalAuthenticationChecks(UserDetails userDetails,
            HMACAuthenticationToken authentication)
    ...
    public Authentication authenticate(Authentication authentication)
            throws AuthenticationException {
        Assert.isInstanceOf(HMACAuthenticationToken.class, authentication,
                () -> messages.getMessage(
    ...
    protected Authentication createSuccessAuthentication(Object principal,
        ...
        HMACAuthenticationToken result = new HMACAuthenticationToken(
    ...
    public boolean supports(Class<?> authentication) {
        return (HMACAuthenticationToken.class
